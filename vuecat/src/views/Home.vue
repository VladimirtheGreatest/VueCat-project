  ...
  <v-container fluid>
    <v-row>
      <v-col class="mb-5" sm="12" md="12" xs="12">
        <div :class="{'my-8': $vuetify.breakpoint.smAndDown, 'ml-10 mt-10': $vuetify.breakpoint.mdAndUp}">
    ...
    <v-row>
      <v-col class="mb-5" sm="12" md="12" xs="12">
        <v-layout class="mb-5" align-center justify-center>
          <v-btn :class="{'pink font-weight-bold mb-10': $vuetify.breakpoint.smAndDown, 'pink font-weight-bold mt-12': $vuetify.breakpoint.mdAndUp}" dark large @click="loadNextImage">
        ...
        <v-layout>
          <v-flex xs12>
            ...
            <v-card v-else class="mx-auto mb-5" max-width="800" max-height="500" outlined elevation="24" rounded>
              <v-img id="card" :src="image.url" max-width="800" max-height="500">
              </v-img>
            </v-card>
          </v-flex>
        </v-layout>
